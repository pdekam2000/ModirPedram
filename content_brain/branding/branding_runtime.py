...
def _branding_settings(profile: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "cta_position": str(profile.get("cta_position") or "top_right"),
        "cta_start_seconds": float(profile.get("cta_start_seconds") or 5),
        "cta_end_seconds": float(profile.get("cta_end_seconds") or 24),
