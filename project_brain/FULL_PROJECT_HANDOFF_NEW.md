...
- ModirAgentOS_CORE_BACKUPaussssssss\full_selfcare_factory.py | role=GENERAL | priority=100
- test_full_ai_video_pipeline.py | role=TEST | priority=95
- ModirAgentOS_CORE_BACKUPaussssssss\test_full_ai_video_pipeline.py | role=TEST | priority=95
- main.py | role=MAIN_ENTRY | priority=90
- ModirAgentOS_CORE_BACKUPaussssssss\main.py | role=MAIN_ENTRY | priority=90
- core\master_orchestrator_engine.py | role=ORCHESTRATOR | priority=85
- core\orchestrator.py | role=ORCHESTRATOR | priority=85
- ModirAgentOS_CORE_BACKUPaussssssss\core\master_orchestrator_engine.py | role=ORCHESTRATOR | priority=85
- ModirAgentOS_CORE_BACKUPaussssssss\core\orchestrator.py | role=ORCHESTRATOR | priority=85
- ModirAgentOS_CORE_BACKUPaussssssss\orchestrators\hailuo_multi_clip_orchestrator.py | role=ORCHESTRATOR | priority=85
