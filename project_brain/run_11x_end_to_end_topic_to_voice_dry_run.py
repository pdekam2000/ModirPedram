...
def write_report(data: dict[str, Any]) -> Path:
    lines = [
        ...
        "",
        "```json",
        json.dumps(data["video_slot"], indent=2),
        "```",
        "",
        ...
        "",
        "```json",
        json.dumps(data["voice_slot"], indent=2),
        "```",
        "",
        ...
        "",
        "```json",
        json.dumps(data["approval_gate"], indent=2),
        "```",
        "",
        "## Live TTS Blocked (Expected)",
        "",
        "```json",
        json.dumps(data["live_tts_blocked"], indent=2),
        "```",
        "",
        ...
        "",
        "```json",
        json.dumps(data.get("preflight_ops_mirror"), indent=2),
        "```",
        "",
    ]
